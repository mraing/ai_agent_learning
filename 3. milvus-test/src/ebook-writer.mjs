...
// 用 import.meta.url 相对脚本自身解析，避免受启动时工作目录影响
const EPUB_FILE = fileURLToPath(new URL('./天龙八部.epub', import.meta.url));
...
const embeddings = new OpenAIEmbeddings({
  ...
  // dimensions（复数）会传给向量 API 做维度截断，与集合的 VECTOR_DIM 保持一致
