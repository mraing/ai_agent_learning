 ...
 * @Date: 2026-09-16 22:38:29
 * @LastEditors: 绪锋 910408228@qq.com
 * @LastEditTime: 2026-09-16 22:45:08
 * @FilePath: /ai agent learning/2. rag-test/src/CharacterTextSplitter-test.mjs
...
// 编码器必须在使用前初始化（lengthFunction 里会同步调用它）
