 ...
 * @Date: 2026-09-17 22:52:10
 * @LastEditors: 绪锋 910408228@qq.com
 * @LastEditTime: 2026-09-17 23:00:45
 * @FilePath: /ai agent learning/6. prompt-template-test/src/pipeline-prompt-template.mjs
...
export const pipelineFormatted = await pipelinePrompt.format({
  tone: '专业、清晰、略带幽默',
  company_name: '星航科技',
  team_name: 'AI 平台组',
  manager_name: '王总',
